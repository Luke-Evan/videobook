...
1. [开场：GPT-6 发布了，但品位还没学会](#1-gpt-6)
2. [AI 时代还要不要学操作系统和数据库](#2-ai)
3. [一个软件工程项目从哪里开始](#3)
4. [什么是软件：需求在信息世界的投影](#4)
5. [Git 之前：U 盘、压缩包与邮件](#5-git-u)
6. [惊人的注意力：从 GitHub 上学会品位](#6-github)
7. [从需求推导出版本控制：你也能发明 Git](#7-git)
8. [Git 简史与它的 First Principle](#8-git-first-principle)
9. [Git 上手四件套：init / add / status / commit](#9-git-init-add-status-commit)
10. [Commit Message 是项目的历史轨迹](#10-commit-message)
11. [空提交与 tag：finalize 一个版本](#11-tagfinalize)
12. [`git add .` 的代价：什么不该进版本库](#12-git-add)
13. [让 AI 当代码审查员：从批评到重写历史](#13-ai)
14. [高血压时刻：dist、log、.DS_Store 与活着的 API Key](#14-distlogds_store-api-key)
15. [Hook：把规范固化成自动检查](#15-hook)
16. [Git 的底层数据结构：blob / tree / commit](#16-git-blob-tree-commit)
17. [Vibe Coding 一个 Git 仓库可视化工具](#17-vibe-coding-git)
18. [可视化分支、冲突与合并](#18)
19. [把 Python 教给小学生：架构自己把关，其余外包给 AI](#19-python-ai)
20. [工程细节：Conventional Commits 与中英文空格](#20-conventional-commits)
21. [Commit Often, Perfect Later：小步提交的工程理由](#21-commit-often-perfect-later)
22. [总结：Git 是用 Atomic Change 推进的快照](#22-git-atomic-change)
23. [附：讲者自己的多 Agent 工作流](#23-agent)
